...
<div class="container">
	...
	<div class="porfolio">
		...
		<div class="img-deets">
			<p class="desc"><c:out value="${thisProject.description}" /></p>
			<p class="d-flex justify-content-end"><c:out value="${thisProject.likers.size()}"/> <a href="/projects/${thisProject.id}/likers" style="color: #0DCAF0"> likes!</a></p>
